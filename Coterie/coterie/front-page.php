<?php
/**
 * Coterie — front-page.php
 * Pulls all content from inc/helpers.php (Customizer-backed),
 * then renders the homepage in the Coterie design language.
 */
if ( ! defined( 'ABSPATH' ) ) exit;

$identity   = coterie_get_identity();
$hero       = coterie_get_hero();
$on1_content = [
    'identity'   => $identity,
    'lede'       => $hero['lede'],
    'principles' => coterie_get_principles(),
    'services'   => coterie_get_services(),
    'work'       => coterie_get_work(),
    'tiers'      => coterie_get_tiers(),
    'faq'        => coterie_get_faq(),
];
