<?php
/**
 * aim1o — Backend experience. The theme's "Obsidian & Gilt" feeling is
...
add_filter( 'admin_footer_text', function () {
	return '<span style="color:var(--v-ink3)">aim1o <span style="color:var(--v-gold)">✦</span> ' . esc_html__( 'Studio control center', 'raveenthiran' ) . '</span>';
} );
...
function nr_control_hub_render() {
	...
	<div class="wrap nr-settings">
		<header class="nr-adm-head">
			<span class="nr-adm-eyebrow"><span class="nr-adm-rule"></span>CONTROL CENTER // aim·1o</span>
...
add_action( 'admin_bar_menu', function ( $bar ) {
	...
	$bar->add_node( [
		...
		'meta'  => [ 'title' => __( 'Back to the aim1o control center', 'raveenthiran' ) ],
	] );
}, 8 );
