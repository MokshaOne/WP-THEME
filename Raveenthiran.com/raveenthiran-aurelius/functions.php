<?php
/**
 * Aurelius — cinematic gallery theme for photographers.
 * Standalone sibling of Obscura: registers the same nr_* CPTs,
 * taxonomies, ACF fields and Theme Settings, so all content is
 * shared — switch between the two themes freely to compare.
 * functions.php
 */
