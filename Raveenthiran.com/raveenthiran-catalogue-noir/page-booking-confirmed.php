 ...
 *
 * Catalogue Noir-styled landing for the post-booking redirect. Set this
 * URL as the LatePoint redirect-after-booking destination so customers
 * land here instead of LatePoint's default confirmation screen.
 *
 * LatePoint may pass booking_id / order_id / step / status as query
 * params; we display them when available but don't rely on them.
 */
