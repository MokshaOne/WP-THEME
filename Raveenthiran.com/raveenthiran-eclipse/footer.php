...
<?php /* ── ECLIPSE tactical HUD bar (VOID-style status line) ────── */ ?>
<div class="ec-hud" aria-hidden="true">
	<div class="ec-hud__left">
		<span class="ec-hud__brand"><?php echo esc_html( strtoupper( $nr_logo_text ) ); ?> // ECLIPSE</span>
		<span class="ec-hud__dots"><span></span><span></span><span></span></span>
	</div>
	<div class="ec-hud__right">
		<span><?php echo esc_html( nr_opt( 'nr_void_lat', '48.2082° N' ) ); ?></span>
		<span><?php echo esc_html( nr_opt( 'nr_void_long', '16.3738° E' ) ); ?></span>
		<span class="ec-hud__status"><i></i><?php esc_html_e( 'SYSTEM: OPERATIONAL', 'raveenthiran' ); ?></span>
	</div>
</div>
