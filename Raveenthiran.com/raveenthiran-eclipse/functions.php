<?php
/**
 * ECLIPSE — a fusion of Obscura + Aurelius + VOID.
 * Standalone sibling: registers the same nr_* CPTs, taxonomies, ACF
 * fields, shortcodes and Theme Settings, so all content is shared —
 * install it alongside the others and switch freely.
 * functions.php
 */
