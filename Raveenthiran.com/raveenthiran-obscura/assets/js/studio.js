...
(function () {
  ...
  /* ---------- gold side rails ----------
     Two wide, silky gold→paper gradients breathing in from the
     edges. Pure CSS (see .st-rail); this only creates the elements.
     They sit at z-index:-1, so photography and dark sections pass
     over them. magic.js modulates their glow with scroll velocity. */
  (function rails() {
    if (!doc.body) return;
