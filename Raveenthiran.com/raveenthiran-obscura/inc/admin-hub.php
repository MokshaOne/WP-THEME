...
function nr_tools_hub_page() {
	...
	$groups = [
		...
		__( 'Content', 'raveenthiran' ) => [
			...
			[ __( 'Tag clusters', 'raveenthiran' ), __( 'Tags by use; spot orphans/duplicates.', 'raveenthiran' ), admin_url( 'admin.php?page=nr-tags' ), 'dashicons-tag' ],
			[ __( 'Series grid', 'raveenthiran' ), __( 'Compare frames across each series.', 'raveenthiran' ), admin_url( 'admin.php?page=nr-series-grid' ), 'dashicons-grid-view' ],
			[ __( 'Alt-text editor', 'raveenthiran' ), __( 'Fix images with missing alt text in bulk.', 'raveenthiran' ), admin_url( 'admin.php?page=nr-alts' ), 'dashicons-universal-access-alt' ],
		],
		__( 'SEO & ops', 'raveenthiran' ) => [
			[ __( 'Redirects', 'raveenthiran' ), __( '301 / 410 map for moved or gone URLs.', 'raveenthiran' ), admin_url( 'admin.php?page=nr-redirects' ), 'dashicons-randomize' ],
			[ __( 'Generate WebP', 'raveenthiran' ), __( 'Bake .webp twins for every image size.', 'raveenthiran' ), admin_url( 'admin.php?page=nr-webp' ), 'dashicons-images-alt2' ],
			[ __( 'Error log', 'raveenthiran' ), __( 'Theme-scoped lines from debug.log.', 'raveenthiran' ), admin_url( 'admin.php?page=nr-log' ), 'dashicons-warning' ],
			[ __( 'Feature flags', 'raveenthiran' ), __( 'Every nr_fx_* toggle and its current state.', 'raveenthiran' ), admin_url( 'admin.php?page=nr-flags' ), 'dashicons-controls-play' ],
			[ __( 'Components', 'raveenthiran' ), __( 'Live render of every UI block (visual QA).', 'raveenthiran' ), admin_url( 'admin.php?page=nr-components' ), 'dashicons-layout' ],
		],
		__( 'Settings & data', 'raveenthiran' ) => [
			...
			[ __( 'Pricing & Quote', 'raveenthiran' ), __( 'Prices behind the enquiry price-check (needs ACF).', 'raveenthiran' ), admin_url( 'admin.php?page=nr-site-settings' ), 'dashicons-money-alt' ],
