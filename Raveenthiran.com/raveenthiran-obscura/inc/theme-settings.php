				...
				<table class="form-table" role="presentation">
					...
					<tr><th><label><?php esc_html_e( 'Accent color', 'raveenthiran' ); ?></label></th>
						<td><?php nr_field_color( 'nr_accent' ); ?>
							<p class="description"><?php esc_html_e( 'The single accent — engraved hairlines only. Default: #C8B79B (travertine). Applied site-wide via the --amber CSS variable.', 'raveenthiran' ); ?></p></td></tr>
				...
				<table class="form-table" role="presentation">
					<tr><th><label><?php esc_html_e( 'Background', 'raveenthiran' ); ?></label></th>
						<td><?php nr_field_color( 'nr_color_bg' ); ?>
							<p class="description"><?php esc_html_e( 'Page canvas. Default: #0A0B0E (cool graphite void).', 'raveenthiran' ); ?></p></td></tr>
					<tr><th><label><?php esc_html_e( 'Ink (text)', 'raveenthiran' ); ?></label></th>
						<td><?php nr_field_color( 'nr_color_ink' ); ?>
							<p class="description"><?php esc_html_e( 'Primary text color. Default: #ECE9E2 (marble bone).', 'raveenthiran' ); ?></p></td></tr>
				</table>
