 ...
 *
 * Layout: header (fixed) · scrollable body · sticky footer (total + actions).
 */
...
<div id="nr-quote" class="nr-modal nr-quote" aria-hidden="true" role="dialog" aria-modal="true" aria-labelledby="nr-quote-title">
	<div class="nr-modal__panel nr-quote__panel">
		...
		<header class="nr-quote__head">
			...
			<p><?php esc_html_e( 'A guide, not a final quote. Pick a type, add what you need, see a number.', 'raveenthiran' ); ?></p>
		</header>
		...
		<form class="nr-quote__form" data-quote-form
			...
			<footer class="nr-quote__foot">
				...
				<div class="nr-quote__actions">
					<button type="button" class="nr-btn nr-btn--ghost" data-modal-close>
						<span><?php esc_html_e( 'Close', 'raveenthiran' ); ?></span>
					</button>
					<button type="button" class="nr-btn nr-btn--primary" data-quote-apply>
						<span><?php esc_html_e( 'Use this', 'raveenthiran' ); ?></span> <span>→</span>
					</button>
				</div>
			</footer>
		</form>
