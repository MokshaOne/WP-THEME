<?php
/**
 * VOID — "Obsidian & Gilt" spatial archive theme for photographers.
 * Standalone sibling of Obscura / Aurelius: registers the same nr_* CPTs,
 * taxonomies, ACF fields, shortcodes and Theme Settings, so all content is
 * shared — install it alongside them and switch freely.
 * functions.php
 */

if ( ! defined( 'ABSPATH' ) ) exit;

define( 'NR_THEME_VERSION', '1.2.0' );
