...
Paper cream + oxblood + serif + asterism breaks. A quiet, dignified theme for poets, essayists and editorial publications.
...
2. Activate.
3. Open **wp-admin → Appearance → Customize → Verse · Site content**.
