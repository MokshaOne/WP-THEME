<?php
/**
 * Verse — front-page.php
 * Pulls all content from inc/helpers.php (Customizer-backed),
 * then renders the homepage in the Verse design language.
 */
if ( ! defined( 'ABSPATH' ) ) exit;

$identity   = verse_get_identity();
$hero       = verse_get_hero();
$on1_content = [
    'identity'   => $identity,
    'lede'       => $hero['lede'],
    'principles' => verse_get_principles(),
    'services'   => verse_get_services(),
    'work'       => verse_get_work(),
    'tiers'      => verse_get_tiers(),
    'faq'        => verse_get_faq(),
];
