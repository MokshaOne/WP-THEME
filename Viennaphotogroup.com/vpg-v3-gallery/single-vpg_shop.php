...
?>
    ...
    <section class="g-phero">
      <div class="g-wrap">
        <p class="g-kicker" style="margin-bottom:16px"><?php esc_html_e( 'Shop', 'vpg-v2' ); ?><?php if ( $meta ) echo ' · ' . esc_html( $meta ); ?></p>
    ...
    <section class="g-section g-section--alt" style="text-align:center">
        <div class="g-wrap">
            <a class="g-btn g-btn--red" href="<?php echo esc_url( get_post_type_archive_link( 'vpg_shop' ) ); ?>"><?php esc_html_e( 'All shops', 'vpg-v2' ); ?> <span class="a">→</span></a>
        </div>
    </section>
