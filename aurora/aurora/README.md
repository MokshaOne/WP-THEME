...
Dark + magenta→violet gradient + glow auras. A rebuild of the Maxreach SEO direction in pure PHP/CSS/JS.
...
2. Activate.
3. Open **wp-admin → Appearance → Customize → Aurora · Site content**.
