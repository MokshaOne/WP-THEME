...
12. ✅ _v4.67.0_ — **Image hotspots** — annotate a frame with small note pins (behind-the-scenes). _Content · M_
...
15. ✅ _v4.67.0_ — **Series mood-board intro** — auto-compose a palette/grid intro screen per series. _Awww · M_
...
25. ✅ _v4.67.0_ — **Offline-readable journal** — cache opened articles so they survive a tunnel/flight. _Perf · M_
26. ✅ _v4.57.0_ — **Cursor "compass"** — a tiny edge indicator showing how much rail is left to scroll. _Awww · S_

## ⚡ Performance & resilience
27. ✅ _v4.67.0 (dominant-colour placeholder)_ — **BlurHash placeholders** — sharper than the current LQIP, ~30 bytes each. _Perf · M_
...
42. ✅ _v4.67.0_ — **Moodboard upload on Enquire** — let a client attach reference images with the brief. _Conv · M_
43. ✅ _v4.57.0_ — **Client onboarding page** — "what to expect / what to bring", linked from the booking confirmation. _Content · S_
44. ✅ _v4.67.0_ — **Pre-shoot countdown emails** — info-only drip (location, prep) before the date. _Conv · M_
...
**List complete — nothing open.** 🎉

_Status: 44/50 shipped · 6 removed/won't-do (#1/#2/#3/#4/#5/#9) · 0 open.
v4.67.0 (finishers): #12 image hotspots, #15 series mood-board, #25 offline
journal (persistent reader cache), #27 dominant-colour placeholder, #42 moodboard
upload on Enquire, #44 pre-shoot countdown emails.
