...
Dark + burnt orange moon + dotted grid background. A rebuild of the Pixelon creative-digital direction in pure PHP/CSS/JS.
...
2. Activate.
3. Open **wp-admin → Appearance → Customize → Eclipse · Site content**.
