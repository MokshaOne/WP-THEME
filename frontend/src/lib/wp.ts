...
const SAMPLE: Project[] = [
	...
	{ slug: 'dianlx-viecc', title: 'Dianlx — VIECC', category: 'Event', year: '2024', client: 'VIECC', location: 'Vienna', website: '', services: ['Event'], series: [{ name: 'VIECC', slug: 'viecc' }], credits: [], featured_home: false, focal: '50% 20%', image: S('photos-1787300135316-3app.avif'), content: '', gallery: gal('photos-1787300135316-3app.avif'), ogImage: '' },
	{ slug: 'milky-viecc', title: 'Milky — VIECC', category: 'Event', year: '2024', client: 'VIECC', location: 'Vienna', website: '', services: ['Event'], series: [{ name: 'VIECC', slug: 'viecc' }], credits: [], featured_home: false, focal: '50% 20%', image: S('photos-1787300135360-vkq6.avif'), content: '', gallery: gal('photos-1787300135360-vkq6.avif'), ogImage: '' },
