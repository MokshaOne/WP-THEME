...
(function () {
	...
	function initHero() {
		...
		var eyebrowEl = hero.querySelector('[data-hero-eyebrow]');
		...
		function arm() { if (heroTimer) clearInterval(heroTimer); if (!reduce) heroTimer = setInterval(function () { go(i + 1); }, 5600); }
		arm();
	}
