<?php
/**
 * VOID front page — the Singularity, now a HORIZONTAL slider: an orbiting core
 * + display wordmark, the featured specimen plate, and the live HUD stats +
 * CTA each ride their own panel. Vertical wheel travels sideways on desktop
 * (mk-scroll.js); native vertical stack on touch. Content via the nr_* engine.
 */
...
<div class="mk-h" data-mk-h>
	<div class="mk-h__track">
		...
		<?php /* ── the singularity ─────────────────────────────── */ ?>
		<section class="mk-panel mk-panel--intro void-home mk-home">
