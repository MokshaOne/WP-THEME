/**
 * VOID — WebGL 3D imagery, site-wide (progressive enhancement).
 *
...
(function () {
  ...
  var FRAG = [
    ...
    '  vec3 gold=vec3(0.949,0.792,0.314);',   /* VOID gilt #f2ca50 */
  ...
  function mount(media, img, opts) {
    ...
    // moksha1one Magic Control — global motion intensity (0–2×)
    var mkI = parseFloat( getComputedStyle( document.documentElement ).getPropertyValue( '--mk-i' ) );
    if ( isFinite( mkI ) && mkI >= 0 ) { bulge *= mkI; tilt *= mkI; }
