...
Solid oxblood full-bleed + centered ⁕ + sparse type. A rebuild of the Geroz creative-portfolio direction in pure PHP/CSS/JS.
...
2. Activate.
3. Open **wp-admin → Appearance → Customize → Monolith · Site content**.
