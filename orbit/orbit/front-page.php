<?php
/**
 * Orbit — front-page.php
 * Pulls all content from inc/helpers.php (Customizer-backed),
 * then renders the homepage in the Orbit design language.
 */
if ( ! defined( 'ABSPATH' ) ) exit;

$identity   = orbit_get_identity();
$hero       = orbit_get_hero();
$on1_content = [
    'identity'   => $identity,
    'lede'       => $hero['lede'],
    'principles' => orbit_get_principles(),
    'services'   => orbit_get_services(),
    'work'       => orbit_get_work(),
    'tiers'      => orbit_get_tiers(),
    'faq'        => orbit_get_faq(),
];
