...
Pure black + phosphor green + JetBrains Mono. A brutalist terminal-style theme for musicians, hackers and tinkerers.
...
2. Activate.
3. Open **wp-admin → Appearance → Customize → Phosphor · Site content**.
