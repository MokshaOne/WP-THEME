...
Dark + crimson red + heavy declarative display. A rebuild of the Gaudy creative-agency direction in pure PHP/CSS/JS.
...
2. Activate.
3. Open **wp-admin → Appearance → Customize → Revolt · Site content**.
