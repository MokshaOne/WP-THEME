<?php
/**
 * Revolt — front-page.php
 * Pulls all content from inc/helpers.php (Customizer-backed),
 * then renders the homepage in the Revolt design language.
 */
if ( ! defined( 'ABSPATH' ) ) exit;

$identity   = revolt_get_identity();
$hero       = revolt_get_hero();
$on1_content = [
    'identity'   => $identity,
    'lede'       => $hero['lede'],
    'principles' => revolt_get_principles(),
    'services'   => revolt_get_services(),
    'work'       => revolt_get_work(),
    'tiers'      => revolt_get_tiers(),
    'faq'        => revolt_get_faq(),
];
