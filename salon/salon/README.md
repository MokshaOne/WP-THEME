...
Light cream + hot pink + serif italic accents. A rebuild of the Revolix digital-marketing direction in pure PHP/CSS/JS.
...
2. Activate.
3. Open **wp-admin → Appearance → Customize → Salon · Site content**.
