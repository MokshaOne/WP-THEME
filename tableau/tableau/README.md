...
Warm dark + amber + cinematic 21:9 hero. For photographers, art directors and image-led portfolios.
...
2. Activate.
3. Open **wp-admin → Appearance → Customize → Tableau · Site content**.
