...
<header class="vpg-page-hero">
    <span class="vpg-chip vpg-chip--review"><span class="vpg-chip__dot"></span> Buying guide</span>
    <h1>Gear, <em>reviewed</em>.</h1>
    <p class="vpg-lede">Cameras, lenses, analog equipment and accessories — scored on design, performance and price by members who actually own them.</p>
    <p class="vpg-caps" style="margin-top:1.5rem"><?php printf( esc_html__( '%d entries', 'vpg-v2' ), $total ); ?> · Gear · scored /10</p>
</header>
    ...
    <div class="vpg-wrap">
                ...
                ?>
                    <article class="vpg-card">
                        <a href="<?php the_permalink(); ?>">
                            ...
                            <span class="vpg-chip vpg-chip--review" style="margin-bottom:.8rem"><span class="vpg-chip__dot"></span> Buying guide</span>
                            <h3><?php the_title(); ?></h3>
                            <?php if ( has_excerpt() ) : ?>
        ...
        <?php else : ?>
            <div class="vpg-quote" style="margin:6rem auto">
                <span class="vpg-asterism vpg-asterism--mark"></span>
                <blockquote>The buying guide is being written.</blockquote>
