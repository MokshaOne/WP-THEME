...
add_action( 'wp_enqueue_scripts', function () {
    ...
    if ( is_post_type_archive( 'vpg_location' ) || is_singular( 'vpg_location' ) || is_singular( 'vpg_studio' ) || is_singular( 'vpg_shop' ) || is_page_template( 'templates/page-map-guide.php' ) || get_query_var( 'vpg_member' ) ) {
        // Leaflet core
